...
<head>
<title>Sistem Informasi Nagari Galugua</title>
<meta charset="utf-8">
...
<div class="wrapper row1">
  <header id="header" class="hoc clear">
    <div id="logo" class="fl_left"> 
    	...
    	<h1 class="logoname" style="float:right; margin-top:-5px; margin-left:20px">SI Nagari Galugua</h1>
    ...
    <nav id="mainav" class="fl_right"> 
      ...
      <li class=""><a href="?h=produk">Produk Nagari</a></li>
        <li ><a class="drop" href="#">Pendaftaran</a>
          <ul style="background: black">
             <li><a href="?h=daftar_penduduk">Penduduk</a></li>
          <li><a href="?h=daftar_mitra">Mitra</a></li>
          </ul>
        </li>
...
<div class="bgded overlay" style="background-image:url('gambar/banner.jpg');">
  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
    	    <p>PEMERINTAH KABUPATEN LIMA PULUH KOTA
KECAMATAN KAPUR IX
</p>
...
<div class="wrapper row5" style="position: fixed; bottom: 0;">
  <div id="copyright" class="hoc clear"> 
    <p class="fl_left">Sistem Informasi Nagari Galugua</p>
